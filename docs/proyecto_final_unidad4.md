...
El sistema es factible para el alcance académico porque permite aplicar los contenidos estudiados en la materia, como funciones, paquetes, módulos, structs, métodos, encapsulación, getters, setters, manejo de errores, interfaces, servicios web, JSON, pruebas de software y concurrencia básica.
...
http://localhost:8080/reportes/categoria?nombre=Programacion
